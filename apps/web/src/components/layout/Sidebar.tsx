...
export function Sidebar({ currentPage, onNavigate, userRole }: SidebarProps) {
  const menuItems = [
    ...
    { id: 'events', label: 'Events', icon: Calendar, roles: ['Organizer'] },
    { id: 'venues', label: 'Venues', icon: MapPin, roles: ['Organizer'] },
    ...
    { id: 'attendees', label: 'Attendees', icon: UserCheck, roles: ['Organizer'] },
