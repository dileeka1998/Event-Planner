...
import { ScheduleEventResponseDto, ScheduleEventRequestDto } from './dto/schedule-event.dto';
...
export class SchedulerController {
  ...
  @ApiOperation({ summary: 'Generate AI-powered schedule for an event (Organizer only)' })
  ...
  async generateSchedule(
    ...
    return this.schedulerService.generateSchedule(eventId, organizerId, dto.gapMinutes || 0);
  }
}
